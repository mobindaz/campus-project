    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-slate-400">
          TC requests, multi-office clearance tracking, and certificate
          generation.
        </p>
      </div>
      ...
      <Card className="border-dashed border-slate-800 bg-slate-900/60 p-8 text-center">
        <div className="flex flex-col items-center justify-center space-y-3">
          ...
          <CardTitle className="text-xl text-white">
            TC Management Engine
          </CardTitle>
          <CardDescription className="max-w-md text-slate-400">
            Multi-office approval chains, clearance forms, PDF certificate
            generation, and public QR verification will be implemented in Phase
            7.
          </CardDescription>
        </div>
      </Card>
